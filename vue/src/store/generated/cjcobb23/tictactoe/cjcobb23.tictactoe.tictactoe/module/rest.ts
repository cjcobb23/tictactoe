...
export interface TictactoeQueryCanPlayMoveResponse {
  possible?: boolean;
  reason?: string;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cjcobb23/tictactoe/tictactoe/can_play_move/{gameIndex}/{player}/{x}/{y}
   */
  queryCanPlayMove = (gameIndex: string, player: string, x: string, y: string, params: RequestParams = {}) =>
    this.request<TictactoeQueryCanPlayMoveResponse, RpcStatus>({
      path: `/cjcobb23/tictactoe/tictactoe/can_play_move/${gameIndex}/${player}/${x}/${y}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cjcobb23/tictactoe/tictactoe/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<TictactoeQueryParamsResponse, RpcStatus>({
      path: `/cjcobb23/tictactoe/tictactoe/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cjcobb23/tictactoe/tictactoe/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<TictactoeQueryAllStoredGameResponse, RpcStatus>({
      path: `/cjcobb23/tictactoe/tictactoe/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cjcobb23/tictactoe/tictactoe/stored_game/{index}
   */
   ...
   * @request GET:/cjcobb23/tictactoe/tictactoe/system_info
   */
  querySystemInfo = (params: RequestParams = {}) =>
    this.request<TictactoeQueryGetSystemInfoResponse, RpcStatus>({
      path: `/cjcobb23/tictactoe/tictactoe/system_info`,
      method: "GET",
      format: "json",
      ...params,
    });
